...
3. **시각적 피드백**: 중력 방향에 맞춰 캐릭터의 `localScale.y`를 반전시켜 현재 중력 상태를 직관적으로 전달합니다.
   ![Player](https://github.com/user-attachments/assets/0c48b0cb-62b2-4f91-aea5-7d773b9e7db9)
...
![reverse](https://github.com/user-attachments/assets/ac68a17e-e132-479c-94fd-722082375392)
...
* **인터랙티브 UI**: 좌우 방향키 입력에 따라 중앙과 측면 패널이 애니메이션(`SetTrigger`)과 함께 전환되는 직관적인 UX를 제공합니다.
  ![Select_Stage](https://github.com/user-attachments/assets/0ab1f001-5d9a-4b16-bb63-ba1a14dc7671)
...
* **잡기 및 운반**: 큐브를 잡으면 `isTrigger`를 활성화하여 충돌을 제어하고, 중력을 0으로 만들어 플레이어와 함께 이동하게 합니다.
  ![grab](https://github.com/user-attachments/assets/6545bc67-ed28-4f70-aec2-48185aa417fd)

* **차징 발사**: `X`키를 누르는 시간에 비례해 `Power` 게이지가 상승하며, 키를 뗄 때 `AddForce`를 통해 누적된 힘만큼 큐브를 발사합니다.
  ![shoot](https://github.com/user-attachments/assets/a72cb733-5d48-4c6b-a536-50bc133b4916)

* **목표지점 충돌**: 큐브가 올바른 목표와 충돌할 때 스코어가 상승하며, 파티클 효과 등 시각적 피드백이 나타나도록 구현했습니다.
![goal](https://github.com/user-attachments/assets/6c75ea53-978f-4ed1-9050-5f938c4067c1)
